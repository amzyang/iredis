...
milliseconds. Works like `HEXPIRE`, but the expiration time is specified in
milliseconds instead of seconds.

## Options

The `HPEXPIRE` command supports a set of options that modify its behavior:
...
HPEXPIRE mykey 60000 FIELDS 1 field1
